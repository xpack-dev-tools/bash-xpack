...
The easiest (and recommended) way to install xPack GNU Bash
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/bash@5.2.21-1.1 --verbose
`} </CodeBlock>
...
* add <code>@xpack-dev-tools/bash</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack GNU Bash with
...
it is also possible to install xPack GNU Bash only globally in
...
In order to access the xPack GNU Bash binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/bash/5.2.21-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/bash/5.2.21-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/bash/5.2.21-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-bash-5.2.21-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\bash\\xpack-bash-5.2.21-1</code>.
...
<ul>
<li><code>xpack-bash-5.2.21-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-bash-5.2.21-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/bash/xpack-bash-5.2.21-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/bash
cd ~/Library/xPacks/bash

tar xvf ~/Downloads/xpack-bash-5.2.21-1-darwin-x64.tar.gz
chmod -R -w xpack-bash-5.2.21-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-bash-5.2.21-1-linux-x64.tar.gz</code></li>
<li><code>xpack-bash-5.2.21-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-bash-5.2.21-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/bash/xpack-bash-5.2.21-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/bash
cd ~/.local/xPacks/bash

tar xvf ~/Downloads/xpack-bash-5.2.21-1-linux-x64.tar.gz
chmod -R -w xpack-bash-5.2.21-1
`} </CodeBlock>
