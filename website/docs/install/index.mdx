...
- <code>xpack-bash-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-bash-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-bash-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-bash-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-bash-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-bash-{customField('xpackVersion')}-linux-arm.tar.gz</code>
