...
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/bash/${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\bash\\${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }\\.content\\bin\\TODO.exe --version
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\bash\\xpack-bash-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }\\bin\\TODO.exe --version
${ customField('upstreamVersion') }`
} </CodeBlock>
...
<CodeBlock language="console"> {
`C:\> tree /f %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\bash\\${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }\\.content
Folder PATH listing
