...
# About the xPack GNU Bash

## The project


The **xPack GNU Bash** project is part of the
...
The **xPack GNU Bash** history is presented
...
For all correspondence related to the **xPack GNU Bash**
