...
[GitHub Actions](https://github.com/xpack-dev-tools/bash-xpack/actions/workflows/publish-github-pages.yml).
...
Check the result at https://xpack-dev-tools.github.io/bash-xpack/.
