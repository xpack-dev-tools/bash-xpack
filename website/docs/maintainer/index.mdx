...
named like **xPack GNU Bash v{customField('xpackVersion')}** (mind the dash),
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/bash@${customField('xpackVersion')}.${customField('npmSubversion')} latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/bash@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack GNU Bash v{customField('xpackVersion')} released**_
