...
**@xpack-dev-tools/bash** is an xpm package that packs platform specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/bash-xpack.git/build-assets/package-lock.json
