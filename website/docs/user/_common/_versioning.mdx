...
upstream {props.upstreamName ? props.upstreamName : 'GNU Bash'} project
is a three-number string
such as <code>5.2.21</code>;
...
such as <code>5.2.21-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>5.2.21-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack GNU Bash dependency via
SemVer expressions
such as <code>^5.2.21-1</code> or <code>~5.2.21-1</code>, and
