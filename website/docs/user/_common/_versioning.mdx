...
like <code>5.2.21-<b>1</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>5.2.21-1.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack GNU Bash dependency via
a SemVer expressions
like <code>^5.2.21-1</code> or <code>~5.2.21-1</code>, and
prefer exact matches,
like <code>5.2.21-1.1</code>.
