...
**xPack GNU Bash** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU Bash,
intended for reproducible builds.

<Overview/>

**xPack GNU Bash** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/bash-xpack/tree/xpack/scripts).
...
[`bash-xpack.git/scripts`](https://github.com/xpack-dev-tools/bash-xpack/tree/xpack/scripts/)
