...
title: Getting Started with xPack GNU Bash
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/bash-xpack)

## Overview

**xPack GNU Bash** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of GNU Bash,
intended for reproducible builds.

<Overview/>

The open source **xPack GNU Bash** project is hosted on GitHub as
[`xpack-dev-tools/bash-xpack`](https://github.com/xpack-dev-tools/bash-xpack);
it provides the platform specific binaries as
[release assets](https://github.com/xpack-dev-tools/bash-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/bash-xpack/tree/xpack/build-assets/scripts).
...
The main advantages of using the **xPack GNU Bash** are:
...
The details of installing the **xPack GNU Bash** on various platforms are
presented in the
...
[GitHub Discussions](https://github.com/xpack-dev-tools/bash-xpack/discussions/).
...
[`CHANGELOG.md`](https://github.com/xpack-dev-tools/bash-xpack/blob/xpack/CHANGELOG.md) file.
...
[`bash-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/bash-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/bash-xpack/): It helps others discover our work.
