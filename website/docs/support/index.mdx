...
title: How to get help for bash
...
# How to get help for xPack GNU Bash
...
distribution, not to the upstream GNU Bash itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack GNU Bash**
