...
- Check the [GitHub Discussions](https://github.com/xpack-dev-tools/bash-xpack/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/bash-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/bash-xpack/discussions)
pages.
