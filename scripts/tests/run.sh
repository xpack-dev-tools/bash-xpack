...
function tests_run_all()
{
  ...
  if [ ! -d "${XBB_SOURCES_FOLDER_PATH}/bash-${XBB_CMAKE_VERSION}" ]
  then
      XBB_CMAKE_GIT_URL=${XBB_CMAKE_GIT_URL:-"https://github.com/xpack-dev-tools/bash.git"}
