...
XBB_APPLICATION_NAME=${XBB_APPLICATION_NAME:-"GNU Bash"}

# Used as part of file/folder paths.
XBB_APPLICATION_LOWER_CASE_NAME=${XBB_APPLICATION_LOWER_CASE_NAME:-"bash"}
...
declare -a XBB_APPLICATION_DEPENDENCIES=( bash )
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( ncurses readline libiconv libxml2 libunistring gettext )
